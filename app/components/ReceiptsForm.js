...
export default function ReceiptsForm({ onSubmit, loading }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSubmit({ receiptAmount, description });
    setReceiptAmount("");
    setDescription("");
  };
    ...
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white rounded-2xl shadow-lg p-6 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2">Record your business receipts</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            <div className="flex items-center justify-center space-x-2">
              ...
              <span>{loading ? "Processing..." : "Record Receipt"}</span>
            </div>
          </button>
        </form>
